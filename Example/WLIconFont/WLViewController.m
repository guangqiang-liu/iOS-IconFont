...
- (void)viewDidLoad
{
    ...
    [btn2 setTitle: [WLIcon matchIconCodeWithName:@"scan_o"] forState:UIControlStateNormal];
    ...
    label.text = [WLIcon matchIconCodeWithName:@"right_arrow_o"];
    ...
    label2.text = [NSString stringWithFormat:@"这是用label显示的iconfont:   %@", [WLIcon matchIconCodeWithName:@"check_unselected_o"]];
    ...
    img.image = [WLIcon iconWithName:@"check_selected_o" size:23 color:[UIColor magentaColor]];
